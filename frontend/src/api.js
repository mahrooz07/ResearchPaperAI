...
export const generateSectionText = (idea, title, section, authors, references, image_provided, image_path) =>
  api.post('/generate-section', { idea, title, section, authors, references, image_provided, image_path });
...
export const regenerateSectionText = (idea, title, authors, section_name, existing_sections, references, image_provided, image_path) =>
  api.post('/regenerate-section', { idea, title, authors, section_name, existing_sections, references, image_provided, image_path });
